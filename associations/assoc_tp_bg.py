...
# Teleport around to make debugging easier
import nengo
...
with model:
    ...
    #memory_flav = nengo.Ensemble(n_neurons=400, dimensions=4, intercepts=[intercept_flav_to_loc]*400)
    ...
    # NOTE: this is currently in non-scaled mode
    ...
    #NOTE: taken out because teleportation
    ...
    nengo.Connection(command, env[[0,1]], synapse=None)
